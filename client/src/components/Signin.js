  ...
  return (
    ...
    >
      ...
      <div className="md:flex md:items-center mb-5">
        ...
        <div className="md:w-2/3">
          <button
            className="shadow bg-green-700 hover:bg-green-600 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded"
            type="submit"
          >
            login
          </button>
      ...
      <div className="text-gray-900 pl-10 block">
        ...
        <Link to="/register">
          <button className="shadow ml-8 bg-green-700 hover:bg-green-600 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded">
            sign up
          </button>
        </Link>
      </div>
